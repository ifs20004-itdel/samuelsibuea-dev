...
const Navbar = () => {
    ...
    return (
        <header className={`header font-poppins bg-black flex justify-around items-center align-middle p-5 text-white z-50 w-${ isHome ? 'screen':'full'} space-x-5`} >
            ...
            <nav className={` flex text-lg font-medium`}>
                ...
                <ul className={`${isMenuOpen ? "flex":"hidden"} md:space-x-10 md:block flex-col absolute md:static top-20 left-0 p-5 z-50 space-y-3 md:rounded-none rounded-b-lg bg-black w-full `}>

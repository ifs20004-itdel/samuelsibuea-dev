...
function PostCard() {
  ...
  return ( 
    <div class={`max-w-sm rounded overflow-hidden shadow-lg hover:opacity-90 cursor-pointer animate-fade-up`} onClick={onClick}>
        <img class="w-full" src={del} alt="IT Del" />
        <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">Del Institute of Technology</div>
            <p className=' italic text-sm font-bold '>Sep 2020 - Present</p>
